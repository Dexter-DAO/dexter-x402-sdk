...
describe('payAndFetch', () => {
  ...
  it('loads the upstream SIWX primitives when a signer is derivable and passes through200', async () => {
    // The extension is loaded normally; actual challenge and redirect behavior
    // is covered by siwx-http.test.ts with local HTTP servers.
